...
def postProcess(project):
	...
	top_nodes = odb.rootAssembly.instances['MERGED-1'].nodeSets['CAP_FACE']
	bot_nodes = odb.rootAssembly.instances['MERGED-1'].nodeSets['RING']
	...
	f.close()
	#shutil.move(olddir+'/'+project+'_results.txt', futuredir+'/'+project+'_results.txt')
	#os.chdir(futuredir)
	return