...
test = full_shell(project = proj_name, simpProps = geo_props_use, imperfection = 0.005)
...
#[used figure] 215: 2folds, 1 static step, mesh_mult = 0.5, temp_mult = 0.6, stable_fac = 2e-8, imper = 0.002, extracting pv/cont/twist/centernodes
#[used figure] 216: 4folds, 1 static step, mesh_mult = 1.0, temp_mult = 0.5, stable_fac = 2e-8, imper = 0.002, extracting pv/cont/twist/centernodes
#[used figure?] 217: 3folds, 1 static step, mesh_mult = 1.0, temp_mult = 0.5, stable_fac = 2e-8, imper = 0.005, extracting pv/cont/twist/centernodes
